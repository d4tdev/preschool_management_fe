...
const Todo = ({ role, todos, removeTodo, updateTodo }) => {
    ...
    const handleSubmit = (id) => {
        console.log(id);
        axios.patch(`http://localhost:5080/post/comment/${id}`, {
            msv: localStorage.getItem('msv'),
            cmt: cmt,
        });
        const newCmt = { msv: localStorage.getItem('msv'), cmt: cmt };
            ...
            return todos.map((todo, index) => (
              ...
              /> */}
                    ...
                    <Noti_reply>
                        ...
                        <SendRep_btn onClick={() => handleSubmit(todo.id)}>
                            GỬI
                        </SendRep_btn>
                    </Noti_reply>
                </div>
